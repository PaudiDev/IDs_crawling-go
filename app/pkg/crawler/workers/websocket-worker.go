...
// to one websocket client in a set described by the Conns parameter.
// The websocket client is selected sequentially in a cyclic way.
type WebsocketWorker struct {
	...
	ContentsChan <-chan *wtypes.WsContentElement
